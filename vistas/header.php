    ...
    <div class="container">
        ...
        <img src="../img/logo_buildoc_blanco.png" alt="..." height="36">
        </a>
        ...
        <ul class="navbar-nav ms-auto">
            <li class="nav-item">
            <a class="nav-link" href="inicio.php"> <span class="fas fa-house"></span> Inicio</a>
            ...
            <li class="nav-item">
            <a class="nav-link" href="#"> <span class="fas fa-power-off"></span> Salir</a>
            </li>
        </ul>
        </div>
    </div>
