      ...
      <div class="col-lg-12">
        ...
        <style>
          ...
          .custom-button {
            ...
            /* Elimina el subrayado que se asemeja a un enlace */
          }
        </style>
        ...
        <body class="d-flex align-items-center py bg-body-tertiary">
          ...
          <main class="form-signin w-100 m-auto">
            <form id="myForm">
              <img class="mb-4" src="img/Login/Logo.png" alt="" width="140" height="57">
...
<script src="librerias/bootstrap4/sweetalert.min.js"></script>
</html>